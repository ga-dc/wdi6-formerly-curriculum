...
In the last lesson, you learned how to select elements using jquery and maybe update some of its properties. In this lesson, we want dive a little deeper into some of the more common jQuery functions that exist.
