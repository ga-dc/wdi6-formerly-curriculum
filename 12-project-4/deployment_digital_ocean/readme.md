# To-Dos
* How to tell students to set up a Digital Ocean account? How to phrase $$$ part?
* Why are we doing this?
* What do you call a "normal" server? One that, unlike Heroku, lets you go in and tweak everything?
* What is nginx? Is there a difference between its roles as a web server and a reverse proxy?
* Why does nginx work automatically?
* Is the root psql user different from the root server user?
...
* **Quick set-up.** Can set up a new VPS in 60 seconds.
* **Very fast.** Their Virtual Private Servers (VPS's) run on SSDs.
...
5. **Add SSH Key.** Generate one by running the below code in Terminal.
* Provides increased security and easy log-in from your computer.
* The below command will automatically copy a SSH key to your clipboard.
...
> What does postgresql-contrib do?  
...
> Can we access /etc/ from anywhere locally?
